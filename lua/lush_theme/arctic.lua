...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    DiagnosticVirtualTextWarn { DiagnosticWarn, bg = 'NONE' },
    DiagnosticVirtualTextInfo { DiagnosticInfo, bg = 'NONE' },
    DiagnosticVirtualTextHint { DiagnosticHint, bg = 'NONE' },
    DiagnosticVirtualTextOk { DiagnosticOk, bg = 'NONE' },
